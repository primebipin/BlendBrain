...
import { View, Text, TextInput, Button, StyleSheet, Alert, Image, TouchableOpacity, ActivityIndicator, RefreshControl, ScrollView } from 'react-native';
    ...
    const handleUpdateProfile = async () => {
        try {
            if (!name || !username || !bio) {
                Alert.alert('Error', 'please create your profile with atleast name username and a short bio');
                return;
            }
            setRefreshing(true);
